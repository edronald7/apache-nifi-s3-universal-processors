...
@SeeAlso({PutS3ObjectUniversal.class, FetchS3ObjectUniversal.class, ListS3Universal.class})
@Tags({"Amazon", "S3", "AWS", "Archive", "Tag", "Universal"})
@InputRequirement(Requirement.INPUT_REQUIRED)
@CapabilityDescription("Sets tags on a FlowFile within an Amazon S3 Bucket with dynamic region support. " +
...
public class TagS3ObjectUniversal extends AbstractS3Processor {
