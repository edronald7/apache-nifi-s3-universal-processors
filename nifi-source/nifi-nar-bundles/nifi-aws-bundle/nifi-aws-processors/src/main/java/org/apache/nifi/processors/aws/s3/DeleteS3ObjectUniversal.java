...
@Tags({"Amazon", "S3", "AWS", "Archive", "Delete", "Universal"})
@InputRequirement(Requirement.INPUT_REQUIRED)
@CapabilityDescription("Deletes FlowFiles on an Amazon S3 Bucket with dynamic region support. " +
...
public class DeleteS3ObjectUniversal extends AbstractS3Processor {
